...
package org.scalatestplus.junit {
  ...
  package helpers5 {
    ...
    class IgnoredSuite extends JUnit5Suite {
    ...
    class ManySuite extends JUnit5Suite {
  ...
  class JUnit5SuiteSuite extends funsuite.AnyFunSuite {
    ...
    test("A JUnitSuite with a JUnit 5 Test annotation will cause TestStarting event to be fired") {
      ...
      assert(repA.testStartingEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.HappySuite")
    }
    ...
    test("A JUnitSuite with a JUnit 5 Test annotation will cause TestSucceeded to be fired") {
      ...
      assert(repA.testSucceededEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.HappySuite")
    }
    ...
    test("A JUnitSuite with a JUnit 5 Test annotation on a bad test will cause testFailed to be invoked") {
      ...
      assert(repA.testFailedEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.BitterSuite")
    ...
    test("A JUnitSuite with JUnit 5 Disabled and Test annotations will cause TestIgnored to be fired") {
      ...
      assert(repA.testIgnoredEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.IgnoredSuite")
    }
    ...
    test("A JUnitSuite with two JUnit 5 Test annotations will cause TestStarting and TestSucceeded events to be fired twice each") {
      ...
      assert(repA.testStartingEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.ManySuite")
      ...
      assert(repA.testSucceededEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers5.ManySuite")
