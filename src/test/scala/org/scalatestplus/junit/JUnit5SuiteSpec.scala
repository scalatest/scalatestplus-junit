...
import org.scalatestplus.junit.junit5helpers._
import org.junit.jupiter.api.Test
import org.junit.jupiter.api.Disabled

class JUnit5SuiteSpec extends funspec.AnyFunSpec {

  describe("A JUnit5Suite") {
    it("should return the test names in alphabetical order from testNames") {
      val a = new JUnit5Suite {
      ...
      val b = new JUnit5Suite {}

      assertResult(List[String]()) {
        b.testNames.iterator.toList
      }

      val c = new JUnit5Suite {
        @Test def doThat(): Unit = {}
        @Test def doThis(): Unit = {}
      }
    ...
    it("should return the correct test count from its expectedTestCount method") {
      ...
      val c = new org.scalatestplus.junit.junit4helpers.CSuite
