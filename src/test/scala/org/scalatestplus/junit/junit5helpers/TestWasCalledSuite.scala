 ...
 */
package org.scalatestplus.junit.junit5helpers
...
class TestWasCalledSuite extends JUnit5Suite {
...
class TestWithNonUnitMethod extends JUnit5Suite {
...
class TestWithMethodNamedTest extends JUnit5Suite {
  @Test def doThis(): Unit = {}
  @Test def doThat(): Unit = {}
...
class ASuite extends JUnit5Suite {
  @Test def doThis(): Unit = ()
  @Test def doThat(info: Informer): Unit = ()
}

class BSuite extends JUnit5Suite {
  @Disabled
  @Test def doThis(): Unit = ()
  @Test def doThat(info: Informer): Unit = ()
}

class CSuite extends JUnit5Suite {
  @FastAsLight
  @Test def doThis(): Unit = ()
  @Test def doThat(info: Informer): Unit = ()
}

class DSuite extends JUnit5Suite {
  @FastAsLight
  @SlowAsMolasses
  @Test def doThis(): Unit = ()
  @SlowAsMolasses
...
class ESuite extends JUnit5Suite {
  @FastAsLight
  @SlowAsMolasses
  @Test def doThis(): Unit = ()
  @SlowAsMolasses
...
class ShouldFailSuite extends JUnit5Suite {
